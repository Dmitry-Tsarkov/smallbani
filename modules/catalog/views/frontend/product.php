                            ...
                            <div class="slider-product__wrapper">
                                <?php foreach($product->images as $image): ?>
                                    <div class="slider-product__slide">
                                        <div class="slider-product__cover"></div><img class="slider-product__image" src="<?=$image->getThumbFileUrl('image', 'view')?>" alt="">
                                    </div>
                                <?php endforeach ?>
                            </div>
                                                ...
                                                <?php foreach($product->drawings as $drawing): ?>
                                                    <div class="slider-blueprint__slide">
                                                        <div class="slider-blueprint__cover">
                                                            <img class="slider-blueprint__image" src="<?= $drawing->getThumbFileUrl('image', 'preview') ?>" alt="">
                                                        </div>
                                                    </div>
                                                <?php endforeach; ?>
                                            </div>
                                        ...
                                        <div class="slider-photos__container" ref="container">
                                            ...
                                            <div class="slider-photos__wrapper">
                                                ...
                                                <div class="slider-photos__slide">
                                                    <div class="slider-photos__cover"></div><img class="slider-photos__image" src="<?= $clients->getThumbFileUrl('image', 'view') ?>" alt="">
                                                </div>
                                                <?php endforeach; ?>
                                            </div>
                                ...
                                <?php foreach ($product->colourGroups as $group): ?>
                                    <div class="product-description__select">
                                        ...
                                        <?php foreach ($group->modifications as $toColour): ?>
                                            <input class="product-description__color" name="colour[<?= $toColour->group_id ?>]" type="radio" style="box-shadow: 0px 0px 0px 2px <?= $toColour->colour->hex ?>;" value="<?= $toColour->id ?>">
                                        <?php endforeach; ?>
                                    </div>
                                <?php endforeach; ?>
                                <button class="button js-button is-order" area-label="Заказать за 178 000 ₽">Заказать за 178 000 ₽</button>
                            </div>
                        </div>
                    </div>
                </div>
